...
<head>
    ...
    <title>ChatMe | Privacy Policy</title>
    ...
    <div class="app-layout" id="app-layout">
            ...
            <div class="navbar">
                <div class="navbar-title" id="navbar-title" style="display: inline-flex; margin: 0; position: static; transform: none; left: auto;">
                    <a href="javascript:location.reload();" style="display: flex; align-items: center; text-decoration: none; color: inherit;">
                        ...
                        <span style="font-weight: 900; font-family: 'Nunito', sans-serif;">Privacy</span>
                    </a>
                </div>
        ...
        <section class="privacy-section">
            <div class="privacy-header">
                ...
                <p class="privacy-subtitle">We are committed to protecting your privacy and handling your personal data responsibly and securely.</p>
            </div>
            
            <div class="privacy-content">
                <h2>1. Information We Collect</h2>
                <ul>
                    <li>Name, email, phone number (during account registration)</li>
                    <li>Messages (end-to-end encrypted, we cannot read them)</li>
                    <li>Device and browser details</li>
                    <li>Location data and user interaction patterns</li>
                </ul>
                
                <h2>2. How We Use the Information</h2>
                <ul>
                    <li>To provide and improve our services</li>
                    <li>For account verification and support</li>
                    <li>To detect and prevent misuse or unauthorized access</li>
                </ul>
                
                <h2>3. Third-Party Sharing</h2>
                <ul>
                    <li>We do not share your data with advertisers or unrelated third parties</li>
                    <li>Information may only be disclosed if legally required (e.g., by court order)</li>
                </ul>
                
                <h2>4. Cookies</h2>
                <ul>
                    <li>We use cookies to enhance user experience and functionality</li>
                    <li>You can disable cookies from your browser settings at any time</li>
                </ul>
                
                <h2>5. Age Policy</h2>
                <p>ChatMe is open to users of all ages. However, for users under 18, parental supervision is recommended for safety.</p>
                
                <h2>6. Limitation of Liability</h2>
                <p>While we take every reasonable measure to ensure the security of your data, ChatMe is not liable for any damages, loss of data, or breaches caused by technical errors, cyber-attacks, or external factors. Usage of this platform is entirely at your own risk.</p>
            </div>
        </section>
    </main>
